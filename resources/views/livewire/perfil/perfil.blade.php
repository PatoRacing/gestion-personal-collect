<div class="border p-1">
    <div class="p-2 text-center text-sm grid grid-cols-2 gap-1 lg:grid-cols-4 bg-gray-200">
        ...
        <button 
            class="text-black p-2 rounded text-sm {{ $situacion === 2 ? 'bg-blue-800 text-white' : 'border shadow bg-white' }}"
        ...
        @if(auth()->user()->rol == 'Administrador')
            <button 
                class="text-black p-2 rounded text-sm {{ $situacion === 4 ? 'bg-blue-800 text-white' : 'border shadow bg-white' }}"
